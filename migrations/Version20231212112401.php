 ...
 */
final class Version20231212112401 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE product ADD category_id INT NOT NULL, ADD sub_category_id INT DEFAULT NULL, DROP main_category, DROP sub_category');
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE product ADD main_category VARCHAR(100) NOT NULL, ADD sub_category VARCHAR(100) DEFAULT NULL, DROP category_id, DROP sub_category_id');
    }
}

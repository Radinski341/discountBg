 ...
 */
final class Version20231224130521 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE cart_product_choice (cart_id INT NOT NULL, product_choice_id INT NOT NULL, INDEX IDX_9E94F3F1AD5CDBF (cart_id), INDEX IDX_9E94F3FF726D05C (product_choice_id), PRIMARY KEY(cart_id, product_choice_id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        ...
        $this->addSql('ALTER TABLE cart_product_choice ADD CONSTRAINT FK_9E94F3F1AD5CDBF FOREIGN KEY (cart_id) REFERENCES cart (id) ON DELETE CASCADE');
        $this->addSql('ALTER TABLE cart_product_choice ADD CONSTRAINT FK_9E94F3FF726D05C FOREIGN KEY (product_choice_id) REFERENCES product_choice (id) ON DELETE CASCADE');
    }
